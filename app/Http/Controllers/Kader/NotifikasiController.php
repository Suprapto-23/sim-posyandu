...
class NotifikasiController extends Controller
{
    ...
    public function markAllRead()
    {
        Notifikasi::where('user_id', Auth::id())
                  ...
                  ->update([
                      'is_read' => true,
                      'read_at' => now() // FIX 1: Waktu baca tersimpan
                  ]);
        ...
        try {
            ...
            if ($latestNotifs->isEmpty()) {
                ...
                foreach ($latestNotifs as $n) {
                    ...
                    // FIX 2: Perbaikan class warna agar tidak hilang di Vercel/Production
                    ...
                    // Asumsi struktur $nexus. Sesuaikan index array jika beda ('title'/'judul', 'url'/'link')
            ...
            // FIX 3: Keamanan - Cegah kebocoran SQL/Server Error ke UI
            Log::error('Kader Notifikasi AJAX Error: ' . $e->getMessage());
