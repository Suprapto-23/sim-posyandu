    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .btn-notif { 
            ...
            position: relative; transition: background-color 0.2s ease, border-color 0.2s ease, color 0.2s ease; 
        }
        ...
        .profile-button { 
            ...
            display: flex; align-items: center; gap: 10px; transition: background-color 0.2s ease, border-color 0.2s ease, color 0.2s ease; 
        }
        ...
        .dropdown-link, .dropdown-logout { 
            ...
            color: var(--slate-700); font-size: 13px; font-weight: 700; text-decoration: none; transition: background-color 0.2s ease, border-color 0.2s ease, color 0.2s ease; 
        }
