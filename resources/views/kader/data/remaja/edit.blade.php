...
@section('content')
<div class="remaja-edit-page space-y-5">
        ...
        <div class="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-500">
                    Perbarui data Remaja dengan hati-hati. Perubahan NIK dapat memengaruhi proses sinkronisasi akun warga dan pencarian data layanan Posyandu.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                @if($routeHas('kader.data.remaja.show'))
                    <a href="{{ route('kader.data.remaja.show', $remaja->id) }}"
    ...
    <form id="remajaForm" method="POST" action="{{ route('kader.data.remaja.update', $remaja->id) }}" class="grid grid-cols-1 gap-5 xl:grid-cols-12" novalidate>
        @csrf
        @method('PUT')
        ...
        <section class="space-y-5 xl:col-span-8">
            ...
            <div class="glass-panel rounded-[30px] p-4 sm:p-5">
                <div class="mb-5 flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-slate-900">1. Identitas Remaja</h2>
                        <p class="mt-1 text-xs font-bold leading-5 text-slate-400">
                            Pastikan identitas sesuai data keluarga atau data Posyandu.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            max="{{ now('Asia/Jakarta')->subDay()->toDateString() }}"
                ...
                <div class="mt-5">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <label class="gender-card {{ old('jenis_kelamin', $remaja->jenis_kelamin) === 'L' ? 'active' : '' }} cursor-pointer rounded-[24px] p-4" data-gender-card="L">
                            <input type="radio" name="jenis_kelamin" value="L" class="sr-only gender-radio" {{ old('jenis_kelamin', $remaja->jenis_kelamin) === 'L' ? 'checked' : '' }}>
                        ...
                        <label class="gender-card {{ old('jenis_kelamin', $remaja->jenis_kelamin) === 'P' ? 'active' : '' }} cursor-pointer rounded-[24px] p-4" data-gender-card="P">
                            <input type="radio" name="jenis_kelamin" value="P" class="sr-only gender-radio" {{ old('jenis_kelamin', $remaja->jenis_kelamin) === 'P' ? 'checked' : '' }}>
                            <div class="flex items-center gap-3">
            ...
            <div class="glass-panel rounded-[30px] p-4 sm:p-5">
                <div class="mb-5 flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-slate-900">2. Data Pendidikan</h2>
                        <p class="mt-1 text-xs font-bold leading-5 text-slate-400">
                            Data sekolah dapat diperbarui jika ada perubahan.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            class="input-premium h-12 w-full rounded-2xl px-4 text-sm font-bold text-slate-700 @error('sekolah') input-error @enderror"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="input-premium h-12 w-full rounded-2xl px-4 text-sm font-bold text-slate-700 @error('kelas') input-error @enderror"
            ...
            <div class="glass-panel rounded-[30px] p-4 sm:p-5">
                <div class="mb-5 flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-slate-900">3. Orang Tua dan Domisili</h2>
                        <p class="mt-1 text-xs font-bold leading-5 text-slate-400">
                            Data keluarga digunakan untuk identifikasi sasaran dan kebutuhan kontak.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            class="input-premium h-12 w-full rounded-2xl px-4 text-sm font-bold text-slate-700 @error('nama_ortu') input-error @enderror"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="input-premium h-12 w-full rounded-2xl px-4 text-sm font-bold text-slate-700 @error('telepon_ortu') input-error @enderror"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs font-bold leading-5 text-emerald-700">
                                    Data Remaja sudah terhubung dengan akun warga.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs font-bold leading-5 text-amber-700">
                                    Setelah data disimpan, sistem akan mencoba mencocokkan akun berdasarkan NIK Remaja.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section class="glass-panel rounded-[30px] p-4 sm:p-5">
                ...
                <div class="space-y-3 text-xs font-bold text-slate-500">
                    <div class="flex gap-3 rounded-2xl bg-slate-50/70 p-3">
                        ...
                        <p>NIK Remaja wajib 16 digit dan tidak boleh sama dengan data lain.</p>
                    </div>

                    <div class="flex gap-3 rounded-2xl bg-slate-50/70 p-3">
                        <i class="fa-solid fa-check text-emerald-600"></i>
                        <p>Tanggal lahir harus sebelum hari ini.</p>
                    </div>

                    <div class="flex gap-3 rounded-2xl bg-slate-50/70 p-3">
                        <i class="fa-solid fa-check text-emerald-600"></i>
                        <p>Nama lengkap, orang tua/wali, dan alamat tetap wajib diisi.</p>
                    </div>
            ...
            <section class="rounded-[30px] border border-amber-100 bg-amber-50/70 p-4 sm:p-5">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs font-bold leading-5 text-amber-700">
                            Perubahan identitas sebaiknya dilakukan jika ada kesalahan input atau pembaruan data resmi. Jangan edit cuma karena lagi gabut, database bukan papan coret-coret.
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section class="glass-panel rounded-[26px] p-4 xl:col-span-12">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-sm font-black text-slate-900">Simpan Perubahan Data Remaja</h3>
                    <p class="mt-1 text-xs font-bold text-slate-400">
...
document.addEventListener('DOMContentLoaded', () => {
    const form = document.getElementById('remajaForm');
    ...
    const phoneInput = document.getElementById('telepon_ortu');
    ...
    phoneInput?.addEventListener('input', () => {
        phoneInput.value = phoneInput.value.replace(/[^\d+]/g, '').slice(0, 20);
    ...
    const updateAgePreview = () => {
        ...
        if (result === 'invalid') {
            usiaPreview.textContent = 'Tanggal lahir harus sebelum hari ini.';
    ...
    form?.addEventListener('submit', (event) => {
        const requiredFields = [
            { id: 'nik', label: 'NIK Remaja wajib diisi 16 digit.' },
            { id: 'nama_lengkap', label: 'Nama lengkap Remaja wajib diisi.' },
            { id: 'tempat_lahir', label: 'Tempat lahir wajib diisi.' },
            { id: 'tanggal_lahir', label: 'Tanggal lahir wajib diisi.' },
            { id: 'nama_ortu', label: 'Nama orang tua atau wali wajib diisi.' },
        ...
        if (!document.querySelector('.gender-radio:checked')) {
            event.preventDefault();
            showToast('Pilih jenis kelamin Remaja terlebih dahulu.');
            return;
        }
        ...
        if (ageCheck === 'invalid') {
            event.preventDefault();
            setError(tanggalLahir);
            showToast('Tanggal lahir harus sebelum hari ini.');
            tanggalLahir.focus();
            return;
        }
