...
@section('content')
<div class="remaja-create-page space-y-5">
        ...
        <div class="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-500">
                    Masukkan data Remaja sebagai sasaran layanan Posyandu. Data ini digunakan untuk absensi, pengukuran fisik, pemantauan kesehatan, rekam medis, dan laporan.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                @if($routeHas('kader.import.create'))
                    <a href="{{ route('kader.import.create', ['type' => 'remaja']) }}"
    ...
    <form id="remajaForm" method="POST" action="{{ route('kader.data.remaja.store') }}" class="grid grid-cols-1 gap-5 xl:grid-cols-12" novalidate>
        @csrf
                ...
                <div class="mb-5 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs font-bold leading-5 text-slate-400">
                            Gunakan data sesuai dokumen keluarga atau data Posyandu.
                        </p>
                    </div>
                </div>
            ...
            <div class="glass-panel rounded-[30px] p-4 sm:p-5">
                <div class="mb-5 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs font-bold leading-5 text-slate-400">
                            Data sekolah bersifat pendukung dan boleh dikosongkan jika belum tersedia.
                        </p>
                    </div>
                </div>
            ...
            <section class="glass-panel rounded-[30px] p-4 sm:p-5">
                ...
                <div class="space-y-3 text-xs font-bold text-slate-500">
                    <div class="flex gap-3 rounded-2xl bg-slate-50/70 p-3">
                        ...
                        <p>NIK Remaja wajib 16 digit dan tidak boleh duplikat.</p>
                    </div>
                    ...
                    <div class="flex gap-3 rounded-2xl bg-slate-50/70 p-3">
                        <i class="fa-solid fa-check text-emerald-600"></i>
                        <p>Nama lengkap, orang tua/wali, dan alamat wajib diisi.</p>
                    </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs font-bold leading-5 text-amber-700">
                            Data sekolah dan nomor HP boleh dikosongkan jika belum tersedia. Data wajib tetap harus lengkap agar tidak jadi sampah digital yang dipaksa hidup.
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section class="glass-panel rounded-[26px] p-4 xl:col-span-12">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-sm font-black text-slate-900">Simpan Data Remaja</h3>
                    <p class="mt-1 text-xs font-bold text-slate-400">
                        Setelah disimpan, data masuk ke database Remaja dan dapat digunakan pada fitur layanan Posyandu.
                    </p>
                </div>
