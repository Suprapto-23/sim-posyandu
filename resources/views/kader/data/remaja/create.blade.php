...
@section('content')
    ...
    <div class="w-full space-y-5">
            ...
            <div class="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-3xl">
                    ...
                    <p class="mt-2 max-w-2xl text-sm font-semibold leading-7 text-slate-600">
                        Tambahkan data sasaran Remaja untuk kebutuhan absensi, edukasi kesehatan, pemeriksaan, rekam medis, dan laporan Posyandu.
                    </p>
                    ...
                    <div class="mt-3 max-w-2xl rounded-2xl border border-emerald-100 bg-white/60 px-4 py-3 text-xs font-bold leading-6 text-slate-600">
                        ...
                        Gunakan <span class="font-black text-emerald-700">NIK Remaja</span> sebagai identitas utama. Jika Admin sudah membuat akun warga dengan NIK yang sama, sistem dapat menyinkronkan akun.
                    </div>
                </div>
        ...
        <form
            id="createRemajaForm"
            action="{{ route('kader.data.remaja.store') }}"
            method="POST"
            ...
            <div class="space-y-5">
                ...
                <section class="rounded-[1.75rem] border border-slate-100 bg-white/85 p-5 shadow-sm">
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm font-semibold leading-6 text-slate-500">
                            Isi data identitas Remaja sesuai catatan keluarga atau data layanan Posyandu.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs font-semibold leading-5 text-slate-500">
                                NIK ini dipakai untuk sinkron akun warga dan akses data Remaja.
                            </p>
                ...
                <section class="rounded-[1.75rem] border border-slate-100 bg-white/85 p-5 shadow-sm">
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm font-semibold leading-6 text-slate-500">
                            Data ini opsional, tapi berguna untuk pendataan sasaran Remaja.
                        </p>
                    </div>
                ...
                <section class="rounded-[1.75rem] border border-slate-100 bg-white/85 p-5 shadow-sm">
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm font-semibold leading-6 text-slate-500">
                            Data keluarga digunakan untuk identifikasi dan kontak jika dibutuhkan.
                        </p>
                    </div>
                ...
                <section class="sticky top-5 rounded-[1.75rem] border border-slate-100 bg-white/90 p-5 shadow-sm">
                    ...
                    <div class="mt-5 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3">
                        ...
                        <p class="mt-1 text-xs font-semibold leading-5 text-emerald-700">
                            Setelah data disimpan, sistem akan mencocokkan NIK Remaja dengan akun warga yang dibuat Admin.
                        </p>
                    </div>
                    ...
                    <div class="mt-5 rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3">
                        ...
                        <ul class="mt-3 space-y-2 text-xs font-semibold leading-5 text-slate-600">
                            <li class="flex gap-2">
                                ...
                                <span>NIK Remaja wajib 16 digit dan tidak boleh duplikat.</span>
                            </li>
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                                <span>Nama lengkap, jenis kelamin, orang tua/wali, dan alamat wajib diisi.</span>
                            </li>
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                                <span>Data sekolah boleh dikosongkan jika belum tersedia.</span>
                            </li>
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                                <span>Akun warga boleh dibuat sebelum atau sesudah data Remaja.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mt-5 rounded-2xl border border-amber-100 bg-amber-50 px-4 py-3">
                        ...
                        <p class="mt-2 text-xs font-semibold leading-5 text-amber-700">
                            Sistem akan menampilkan estimasi usia. Jika usia tidak sesuai kategori Remaja, periksa kembali tanggal lahirnya. Jangan sampai data remaja isinya bapak-bapak, nanti sistemnya ikut bingung.
                        </p>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="mt-1 text-xs font-semibold leading-5 text-slate-500">
                            Data akan masuk ke database sasaran Remaja dan siap digunakan untuk layanan Posyandu.
                        </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('createRemajaForm');
