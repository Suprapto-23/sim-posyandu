...
@php
    ...
    $selectedKemandirian = old('tingkat_kemandirian', $lansia->tingkat_kemandirian ?? '');
...
<div class="form-page relative min-h-[calc(100vh-96px)] px-4 py-6 sm:px-6 lg:px-8">
    <div class="relative z-10 mx-auto max-w-6xl space-y-6">
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div class="max-w-3xl">
                        ...
                        <p class="mt-3 max-w-2xl text-sm font-semibold leading-7 text-emerald-50/80 sm:text-base">
                            Perbarui identitas, kondisi kesehatan dasar, dan tingkat kemandirian Lansia. Jangan asal ubah NIK, sistem bukan paranormal.
                        </p>
                    </div>

                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:w-[320px]">
                        <a href="{{ $backRoute }}" class="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 text-center text-sm font-black text-white backdrop-blur-xl transition hover:bg-white/15">
                            Kembali
                        </a>

                        @if($showRoute)
                            <a href="{{ $showRoute }}" class="rounded-2xl bg-emerald-400 px-4 py-4 text-center text-sm font-black text-emerald-950 shadow-[0_18px_40px_rgba(52,211,153,0.24)] transition hover:bg-emerald-300">
                                Detail
                            </a>
                        @endif
                    </div>
        ...
        <form id="lansiaEditForm" action="{{ $updateRoute }}" method="POST" class="glass-card overflow-hidden rounded-[34px]">
            @csrf
            @method('PUT')
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-black text-slate-950">
                            {{ $lansia->nama_lengkap ?? 'Data Lansia' }}
                        </h2>
                    ...
                    <div class="rounded-2xl border {{ $akunTerhubung ? 'border-emerald-200 bg-emerald-50 text-emerald-700' : 'border-amber-200 bg-amber-50 text-amber-700' }} px-4 py-3 text-sm font-black shadow-sm">
                ...
                <section class="rounded-[28px] border border-emerald-100/80 bg-white/72 p-5 shadow-[0_16px_50px_rgba(15,23,42,0.04)] sm:p-6">
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-500">Perbaiki data dasar sasaran.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="nik" name="nik" value="{{ old('nik', $lansia->nik) }}" required maxlength="16" inputmode="numeric" pattern="[0-9]{16}" autocomplete="off" class="form-input @error('nik') form-error @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $lansia->nama_lengkap) }}" required autocomplete="off" class="form-input @error('nama_lengkap') form-error @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $lansia->tempat_lahir) }}" required autocomplete="off" class="form-input @error('tempat_lahir') form-error @enderror">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ $tanggalLahir }}" max="{{ $maxTanggalLahir }}" required class="form-input @error('tanggal_lahir') form-error @enderror">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <textarea id="alamat" name="alamat" rows="4" required class="form-textarea @error('alamat') form-error @enderror">{{ old('alamat', $lansia->alamat) }}</textarea>
                ...
                <section class="rounded-[28px] border border-cyan-100/80 bg-white/72 p-5 shadow-[0_16px_50px_rgba(15,23,42,0.04)] sm:p-6">
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-500">Berat badan, tinggi badan, dan lingkar perut.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-3">
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="berat_badan" name="berat_badan" value="{{ old('berat_badan', $lansia->berat_badan) }}" step="0.01" min="1" max="300" class="form-input pr-14 @error('berat_badan') form-error @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="tinggi_badan" name="tinggi_badan" value="{{ old('tinggi_badan', $lansia->tinggi_badan) }}" step="0.1" min="50" max="250" class="form-input pr-14 @error('tinggi_badan') form-error @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="lingkar_perut" name="lingkar_perut" value="{{ old('lingkar_perut', $lansia->lingkar_perut) }}" step="0.1" min="20" max="200" class="form-input pr-14 @error('lingkar_perut') form-error @enderror">
                                <span class="absolute inset-y-0 right-4 flex items-center text-sm font-black text-slate-400">cm</span>
                            </div>
                ...
                <section class="rounded-[28px] border border-amber-100/90 bg-white/72 p-5 shadow-[0_16px_50px_rgba(15,23,42,0.04)] sm:p-6">
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-500">Tensi, gula darah, kolesterol, asam urat, dan keluhan.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="text" id="tekanan_darah" name="tekanan_darah" value="{{ old('tekanan_darah', $lansia->tekanan_darah) }}" autocomplete="off" placeholder="Contoh: 120/80" class="form-input @error('tekanan_darah') form-error @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="gula_darah" name="gula_darah" value="{{ old('gula_darah', $lansia->gula_darah) }}" step="0.1" min="0" max="999" class="form-input pr-24 @error('gula_darah') form-error @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="kolesterol" name="kolesterol" value="{{ old('kolesterol', $lansia->kolesterol) }}" step="0.1" min="0" max="999" class="form-input pr-24 @error('kolesterol') form-error @enderror">
                                <span class="absolute inset-y-0 right-4 flex items-center text-xs font-black text-slate-400">mg/dL</span>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="asam_urat" name="asam_urat" value="{{ old('asam_urat', $lansia->asam_urat) }}" step="0.1" min="0" max="99" class="form-input pr-20 @error('asam_urat') form-error @enderror">
                                <span class="absolute inset-y-0 right-4 flex items-center text-xs font-black text-slate-400">mg/dL</span>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="penyakit_bawaan" name="penyakit_bawaan" value="{{ old('penyakit_bawaan', $lansia->penyakit_bawaan) }}" autocomplete="off" placeholder="Contoh: Hipertensi" class="form-input @error('penyakit_bawaan') form-error @enderror">
                            @error('penyakit_bawaan') <p class="form-error-text">{{ $message }}</p> @enderror
                        </div>

                        <div class="lg:col-span-3">
                            <label for="keluhan" class="form-label">Keluhan</label>
                            <textarea id="keluhan" name="keluhan" rows="4" placeholder="Tulis keluhan jika ada" class="form-textarea @error('keluhan') form-error @enderror">{{ old('keluhan', $lansia->keluhan) }}</textarea>
...
@push('modals')
<div id="nexusEditConfirm" class="nexus-modal fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/55 px-4 py-6 backdrop-blur-sm">
    <div class="nexus-modal-card w-full max-w-md overflow-hidden rounded-[32px] border border-white/70 bg-white/90 shadow-[0_30px_100px_rgba(15,23,42,0.28)] backdrop-blur-2xl">
        <div class="relative overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-800 to-teal-700 px-6 py-6 text-white">
            ...
            <div class="relative">
                ...
                <h3 class="text-2xl font-black tracking-tight">Simpan Perubahan Data?</h3>

                <p class="mt-2 text-sm font-semibold leading-6 text-white/75">
                    Data Lansia akan diperbarui dan sistem akan menghitung ulang IMT jika berat dan tinggi badan tersedia.
                </p>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-white via-emerald-50/50 to-amber-50/35 px-6 py-5">
            <div class="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-bold leading-6 text-amber-800">
                Pastikan NIK, tanggal lahir, tensi, dan indikator kesehatan sudah benar.
            </div>

            <div class="mt-5 grid grid-cols-2 gap-3">
                <button type="button" id="nexusEditCancel" class="h-12 rounded-2xl border border-slate-200 bg-white px-5 text-sm font-black text-slate-700 transition hover:bg-slate-50">
                    Batal
                </button>

                <button type="button" id="nexusEditOk" class="h-12 rounded-2xl bg-emerald-700 px-5 text-sm font-black text-white shadow-[0_14px_35px_rgba(4,120,87,0.22)] transition hover:bg-emerald-800">
                    Simpan
                </button>
            </div>
        </div>
