...
@php
    ...
    $jenisKelamin = old('jenis_kelamin', $balita->jenis_kelamin ?? '');
...
@section('content')
    ...
    <div class="w-full space-y-5">
            ...
            <div class="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-3xl">
                    ...
                    <p class="mt-2 max-w-2xl text-sm font-semibold leading-7 text-slate-600">
                        Perbarui data Balita dengan hati-hati. Perubahan NIK akan memengaruhi sinkronisasi akun warga dan pencarian data layanan Posyandu.
                    </p>
                ...
                <div class="flex flex-col gap-2 sm:flex-row lg:items-center">
                    ...
                    @if($routeHas('kader.data.balita.show'))
                        <a
                            href="{{ route('kader.data.balita.show', $balita->id) }}"
        ...
        <form
            id="editBalitaForm"
            action="{{ route('kader.data.balita.update', $balita->id) }}"
            method="POST"
                ...
                <section class="rounded-[1.75rem] border border-slate-100 bg-white/85 p-5 shadow-sm">
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm font-semibold leading-6 text-slate-500">
                            Pastikan perubahan identitas sesuai dokumen keluarga atau catatan Posyandu.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs font-semibold leading-5 text-slate-500">
                                NIK ini dipakai untuk sinkron akun warga. Orang tua atau wali memakai akun tersebut untuk mengakses data Balita.
                            </p>
                ...
                <section class="sticky top-5 rounded-[1.75rem] border border-slate-100 bg-white/90 p-5 shadow-sm">
                    ...
                    >
                        ...
                        <p class="mt-1 text-xs font-semibold leading-5">
                            {{ $akunTerhubung ? 'Data Balita sudah terhubung dengan akun warga.' : 'Setelah data disimpan, sistem akan mencoba mencocokkan akun berdasarkan NIK Balita.' }}
                        </p>
                    </div>
                    ...
                    <div class="mt-5 rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3">
                        ...
                        <ul class="mt-3 space-y-2 text-xs font-semibold leading-5 text-slate-600">
                            <li class="flex gap-2">
                                ...
                                <span>NIK Balita wajib 16 digit dan tidak boleh sama dengan data lain.</span>
                            </li>
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                            ...
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                                <span>Nama lengkap, nama ibu, dan alamat tetap wajib diisi.</span>
                            </li>
                            <li class="flex gap-2">
                                <i class="ph-fill ph-check-circle mt-0.5 text-emerald-600"></i>
                    ...
                    <div class="mt-5 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3">
                        <h4 class="text-sm font-black text-emerald-800">
                            Catatan Edit
                        </h4>
