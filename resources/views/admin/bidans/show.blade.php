...
@section('page-title', 'Detail Akun Bidan')
...
@php
    ...
    $initial = Str::upper(Str::substr(trim($name), 0, 1)) ?: 'B';
...
<div class="max-w-5xl mx-auto animate-pop-in pb-12">
    ...
    <section class="bg-gradient-to-br from-sky-500 via-cyan-500 to-teal-500 rounded-[2.5rem] p-8 md:p-12 mb-8 relative overflow-hidden shadow-[0_20px_40px_-12px_rgba(14,165,233,.35)] border border-white/20 text-center">
        ...
        <div class="relative z-10 flex flex-col items-center">
            <div class="w-28 h-28 rounded-[2rem] bg-white border-4 border-white/50 text-sky-500 flex items-center justify-center font-black text-5xl shadow-xl mb-5">
                {{ $initial }}
            </div>
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-3">
                <a href="{{ route('admin.bidans.index') }}" class="bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white text-[11px] uppercase tracking-widest font-bold px-6 py-3 rounded-xl transition-all">
                    <i class="fas fa-arrow-left mr-1"></i>
                    Kembali
                </a>

                <a href="{{ route('admin.bidans.edit', $bidan->id) }}" class="bg-white hover:bg-slate-50 text-teal-600 text-[11px] uppercase tracking-widest font-bold px-6 py-3 rounded-xl transition-all shadow-lg hover:-translate-y-0.5">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="soft-card bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
            ...
            <div class="space-y-4">
                ...
                <div class="info-row">
                    ...
                    <span class="text-[13px] font-black text-teal-600 bg-teal-50 px-2 py-0.5 rounded">
        ...
        <div class="soft-card bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
            <div class="flex items-center gap-4 mb-6 border-b border-slate-50 pb-4">
                <div class="w-12 h-12 rounded-2xl bg-teal-50 text-teal-500 flex items-center justify-center text-xl shrink-0">
            ...
            <div class="space-y-4">
                ...
                <div class="info-row">
                    <span class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">NIK</span>
